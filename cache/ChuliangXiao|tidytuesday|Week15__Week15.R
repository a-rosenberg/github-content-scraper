...
## ----geofacet, message = F, warning = F, fig.height = 6, fig.width = 10----
library(geofacet)
p1 <- st_df %>% 
...
## ----ridge, message = F, warning = F, fig.height = 8, fig.width = 10-----
library(ggridges)
library(viridis)
library(forcats)
...
## ----Scatter, message = F, warning = F, fig.height = 8, fig.width = 10----
library(ggridges)
library(viridis)
library(forcats)
p3 <- raw_df %>% 
...
## ----patchwork, fig.height = 8, fig.width = 10---------------------------
library(patchwork)
