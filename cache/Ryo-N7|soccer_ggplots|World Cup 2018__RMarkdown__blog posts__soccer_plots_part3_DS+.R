...
## ----gazinsky NEW gganimate, eval=FALSE,warning=FALSE, fig.width=8, fig.height=6, fig.align='center'----
## ggplot(pass_data) +
##   annotate_pitch() +
##   theme_pitch() +
##   theme(text = element_text(family = "Dusha V5")) +
...
## ----gazinsky NEW tweenr, eval=FALSE, warning=FALSE, fig.width=8, fig.height=6, fig.align='center'----
## ggplot(pass_data) +
##   annotate_pitch() +
##   theme_pitch() +
##   coord_flip(xlim = c(49, 101),
...
## ----osako NEW tweenr, eval=FALSE, warning=FALSE, fig.height = 5, fig.width = 7, fig.align='center'----
## ggplot(ball_data) +
##   annotate_pitch() +
##   theme_pitch() +
##   theme(
...
## ----tweenr offside NEW, eval = FALSE, warning=FALSE, fig.height=10, fig.width=9, fig.align='center'----
## ggplot(trap_data) +
##   annotate_pitch() +
##   theme_pitch(aspect_ratio = NULL) +
##   coord_fixed(
