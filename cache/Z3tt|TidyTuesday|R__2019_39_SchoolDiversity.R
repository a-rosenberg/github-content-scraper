...
## ----full-panel, fig.width = 14, fig.height = 16.5-----------------------
## panel
...
## ----corr-plot, fig.width = 11.5, fig.height = 12------------------------
df_school_index %>% 
...
## ----geofacet, fig.width = 28, fig.height = 22---------------------------
## geofacet diversity
...
## ----theme-hex-bin-maps, message=FALSE, warning=FALSE--------------------
...
## ----hex-bin-maps, fig.width = 15, fig.height = 6.5----------------------
